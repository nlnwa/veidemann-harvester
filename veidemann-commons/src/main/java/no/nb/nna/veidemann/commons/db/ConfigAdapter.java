...
public interface ConfigAdapter {
    ConfigObject getConfigObject(no.nb.nna.veidemann.api.config.v1.GetRequest request) throws DbException;
    ...
    LabelKeysResponse getLabelKeys(no.nb.nna.veidemann.api.config.v1.GetRequest request) throws DbException;
